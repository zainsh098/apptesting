...
import '../Scan Qr Code/views/qr_create_screen.dart';
import '../Scan Qr Code/views/qr_scanner_screen.dart';
import '../Scan Qr Code/views/qr_scanning_history.dart';
    ...
    return Scaffold(
        ...
        bottomNavigationBar: Padding(
          padding: EdgeInsets.symmetric(
              vertical: height * 0.06, horizontal: width * 0.057),
          child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: width * 0.06),
                    child: Text(
                        'Scan QR codes, generate your own, and keep track of your code history with ease.',
